...
class PlanExecuteState(MessagesState):
    ...
    plot_file_dict:  Annotated[Optional[Dict[str, str]], "Dictionary of names of the plot files generated by the analysis as keys and description of plot as values."]
    markdown_report: Annotated[Optional[str], "Markdown report generated by the agent based on current task and tools description of the agent."]
    term_sheet_data: Annotated[Optional[str], "Term sheet data provided by the user."]
...
class AnalysisAgentScheme(AgentResponseSchema):
    report: str = Field(description="Report generated by the agent in markdown format")
